      ...
      >
        <.icon
          ...
          class={[
            ...
            "[[data-phx-theme=system-light]_&]:text-white",
            "[[data-phx-theme=system-dark]_&]:text-black"
          ]}
        />
      </button>
      ...
      >
        <.icon
          ...
          class={[
            ...
            "[[data-phx-theme=system-light]_&]:text-black"
          ]}
        />
      </button>
      ...
      >
        <.icon
          ...
          class={[
            ...
            "[[data-phx-theme=system-dark]_&]:text-white"
          ]}
        />
      </button>
    </div>
